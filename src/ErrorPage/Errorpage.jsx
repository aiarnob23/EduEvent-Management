...
const Errorpage = () => {
    return (
        <div className="flex w-full dark:bg-gray-900 h-full justify-center items-center">
            <section className=" ">
                <div className="container flex items-center min-h-screen px-6 py-12 mx-auto">
                    <div>
                        ...
                        <div className="flex items-center  mt-6 gap-x-3">
                            <Link to='/'>
                            <button className="w-1/2 px-5 py-2 text-xl tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                                Go Home
                            </button>
                            </Link>
                        </div>
